...
#define Adc_stop 1050
#define Bnt_Led_Pin GPIO_PIN_13
#define Bnt_Led_GPIO_Port GPIOC
...
#define inc_EXTI_IRQn EXTI15_10_IRQn
#define dec_Pin GPIO_PIN_14
#define dec_GPIO_Port GPIOB
#define dec_EXTI_IRQn EXTI15_10_IRQn
